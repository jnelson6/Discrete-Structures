...
(define (union listA listB) (make-set (append listA listB)))
...
(define (intersection listA listB)
  (if (null? listA)
      ...
      (if (element? (car listA) listB)
          (make-set(append (list (car listA)) (intersection (cdr listA) listB)))
...
(define (set-equal? setA setB)
  (equal? (intersection setA setB) setA))
...
(define (set-difference listA listB)
  (if (null? listA)
      ...
      (if (element? (car listA) listB)
          ...
          (make-set (append (list (car listA)) (set-difference (cdr listA) listB)))
           )))
...
(define (disjoint? setA setB)
  (set-equal? (intersection setA setB) '()))
...
(define (insert element lst)
  (make-set (append (list element) lst)))
...
(define (remove element set)
  (sym-diff(append (list element) set) (list element)))
